...
namespace ClsUtils.TICKETS
{
    public class Ticket
    {
        ...
        private string _CabLineas = "CANT  DESCRIPCION           IMPORTE";
        public string CabLineaProd
        {
            set
            {
                this._CabLineas = value;
            }
            get
            {
                return this._CabLineas;
            }
        }
        ...
        private void DrawItems()
        {
            ...
            gfx.DrawString(this._CabLineas, printFont, myBrush, leftMargin, YPosition(), new StringFormat());
